  ...
  works = [
    {
      ...
      image: { src: require('@/assets/images/works/firstlook/nikocale.jpg'), alt: 'nikocale-pic' }
    },
    {
      ...
      image: { src: require('@/assets/images/works/firstlook/setlify.jpg'), alt: 'setlify-pic' }
    },
    {
      ...
      image: { src: require('@/assets/images/works/firstlook/yakukyari.jpg'), alt: 'yakukyari-pic' }
    },
    {
      ...
      image: { src: require('@/assets/images/works/firstlook/dealxpert.jpg'), alt: 'dealxpert-pic' }
    },
    {
      ...
      image: { src: require('@/assets/images/works/firstlook/portfolio.jpg'), alt: 'nikocale-pic' }
    }
  ]
}
</script>
