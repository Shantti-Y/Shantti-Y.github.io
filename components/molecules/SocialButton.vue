<template>
  <a class="sns-button" :class="classNames" :href="url" target="_blank">
    <ion-icon class="ion-icon" :name="ionIconName" :size="30" />
  </a>
</template>
<script lang="ts">
...
export default class SocialButton extends Mixins(ClassName) {
